...
export default function MovieDetails() {
  ...
  useEffect(() => {
    axios.get(`${urlMovies}/${id}`).then((response: AxiosResponse<movieDTO>) => {
  ...
  return movie ? (
    <div>
      ...
      <Ratings maximumValue={5} selectedValue={movie.userVote} onChange={handleRate} /> | Average vote: {movie.averageVote}
